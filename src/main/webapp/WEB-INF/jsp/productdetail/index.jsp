                        ...
                        <div class="modal-body p-0">
                            <div class="row align-items-stretch">
                                <div class="col-lg-6 p-lg-0"><a
                                        ...
                                        href="${pageContext.request.contextPath}/frontend/img/product-5.jpg"
                                        data-gallery="gallery1" data-glightbox="Red digital smartwatch"></a><a
                                        class="glightbox d-none"
                                        href="${pageContext.request.contextPath}/frontend/img/product-5-alt-1.jpg"
                                        data-gallery="gallery1" data-glightbox="Red digital smartwatch"></a><a
                                        class="glightbox d-none"
                                        href="${pageContext.request.contextPath}/frontend/img/product-5-alt-2.jpg"
                                ...
                                <div class="col-lg-6">
                                    <div class="p-4 my-md-4">
                                        ...
                                        <p class="text-muted">$${product.name}250</p>
                ...
                <div class="container">
                    <div class="row mb-5">
                                ...
                                <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0 px-xl-2">
                                    <div class="swiper product-slider-thumbs">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100"
                                                                                                         src="${pageContext.request.contextPath}/frontend/img/product-detail-2.jpg"
                                                                                                         alt="...">
                                            </div>
                                            <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100"
                                                                                                         src="${pageContext.request.contextPath}/frontend/img/product-detail-3.jpg"
                                                                                                         alt="...">
                                            </div>
                                            <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100"
                                                                                                         src="${pageContext.request.contextPath}/frontend/img/product-detail-4.jpg"
                                                                                                         alt="...">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper product-slider">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide h-auto"><a class="glightbox product-view"
                                                                                href="${pageContext.request.contextPath}/frontend/img/product-detail-1.jpg"
                                            ...
                                            <div class="swiper-slide h-auto"><a class="glightbox product-view"
                                                    ...
                                                    alt="..."></a></div>
                                            <div class="swiper-slide h-auto"><a class="glightbox product-view"
                                                                                href="${pageContext.request.contextPath}/frontend/img/product-detail-3.jpg"
                                                                                data-gallery="gallery2"
                                                    ...
                                                    alt="..."></a></div>
                                            <div class="swiper-slide h-auto"><a class="glightbox product-view"
                                                                                href="${pageContext.request.contextPath}/frontend/img/product-detail-4.jpg"
                                                                                data-gallery="gallery2"
                        ...
                        <div class="col-lg-6">
                            ...
                            <a class="text-dark p-0 mb-4 d-inline-block" href="#!"><i class="far fa-heart me-2"></i>Add
                                to wish list</a><br>
                                    ...
                                    <div class="col-lg-8">
                                        <div class="d-flex mb-3">
                                            <div class="flex-shrink-0"><img class="rounded-circle"
                                                                            src="${pageContext.request.contextPath}/frontend/img/customer-1.png"
                                                                            alt="" width="50"/></div>
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0"><img class="rounded-circle"
                                                                            src="${pageContext.request.contextPath}/frontend/img/customer-2.png"
                                                                            alt="" width="50"/></div>
                                            <div class="ms-3 flex-shrink-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="product text-center skel-loader">
                                <div class="d-block mb-3 position-relative"><a class="d-block" href="detail.html"><img
                                        ...
                                        src="${pageContext.request.contextPath}/frontend/img/product-1.jpg"
                                        alt="..."></a>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="product text-center skel-loader">
                                <div class="d-block mb-3 position-relative"><a class="d-block" href="detail.html"><img
                                        class="img-fluid w-100"
                                        src="${pageContext.request.contextPath}/frontend/img/product-2.jpg"
                                        alt="..."></a>
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark"
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="product text-center skel-loader">
                                <div class="d-block mb-3 position-relative"><a class="d-block" href="detail.html"><img
                                        class="img-fluid w-100"
                                        src="${pageContext.request.contextPath}/frontend/img/product-3.jpg"
                                        alt="..."></a>
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark"
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="product text-center skel-loader">
                                <div class="d-block mb-3 position-relative"><a class="d-block" href="detail.html"><img
                                        class="img-fluid w-100"
                                        src="${pageContext.request.contextPath}/frontend/img/product-4.jpg"
                                        alt="..."></a>
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark"
