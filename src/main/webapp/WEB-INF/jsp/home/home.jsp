...
<head>
    ...
    <!-- gLightbox gallery-->
    <link rel="stylesheet" href="frontend/vendor/glightbox/css/glightbox.min.css">
    <!-- Range slider-->
    <link rel="stylesheet" href="frontend/vendor/nouislider/nouislider.min.css">
    <!-- Choices CSS-->
    <link rel="stylesheet" href="frontend/vendor/choices.js/public/assets/styles/choices.min.css">
    <!-- Swiper slider-->
...
<div class="page-holder">
            ...
            <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="index.html"><span class="fw-bold text-uppercase text-dark">Boutique</span></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="/user/login"> <i class="fas fa-user me-1 text-gray fw-normal"></i>Login</a></li>
                    </ul>
                </div>
            </nav>
        </div>
    ...
    <div class="container">
        ...
        <section class="pt-5">
            ...
            <div class="row">
                <div class="col-md-4"><a class="category-item" href="shop.html"><img class="img-fluid" src="frontend/img/cat-img-1.jpg" alt=""/><strong class="category-item-title">Clothes</strong></a>
                </div>
                ...
                <div class="col-md-4"><a class="category-item" href="shop.html"><img class="img-fluid" src="frontend/img/cat-img-4.jpg" alt=""/><strong class="category-item-title">Electronics</strong></a>
                </div>
            </div>
        </section>
        <!-- TRENDING PRODUCTS-->
    ...
    <script src="frontend/vendor/choices.js/public/assets/scripts/choices.min.js"></script>
