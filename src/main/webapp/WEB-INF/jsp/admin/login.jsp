...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/backend/compiled/css/auth.css"/>
</head>
    ...
    <div class="row h-100">
        <div class="col-lg-5 col-12">
            <div id="auth-left">
                <div class="auth-logo">
                    <a href="index.html"
                    ><img src="${pageContext.request.contextPath}/backend/compiled/svg/logo.svg" alt="Logo"
                    /></a>
                </div>
                ...
                <form:form class="user" action="admin/login" method="post" modelAttribute="user">
                    ...
                    <form:button class="btn btn-primary btn-block btn-lg shadow-lg mt-5">
                        Log in
                    </form:button>
                </form:form>
