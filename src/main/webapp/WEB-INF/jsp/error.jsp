...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/backend/compiled/css/error.css" />
</head>
  ...
  <div class="error-page container">
    <div class="col-md-8 col-12 offset-md-2">
      <div class="text-center">
        <img
                class="img-error"
                src="${pageContext.request.contextPath}/backend/compiled/svg/error-404.svg"
                alt="Not Found"
        />
